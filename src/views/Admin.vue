  ...
  >
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <router-link to="/" class="flex justify-center mb-6">
        <img src="../assets/logo.png" alt="istrian-villa-logo" class="w-32" />
      </router-link>
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Dodaj nekretninu</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Prodavatelji</span>
          </a>
        </li>
      </ul>
    </div>
